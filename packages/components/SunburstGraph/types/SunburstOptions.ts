import { SeriesOptions, IgnoreOptions, LineType, ShadowOptions,BorderStyle } from "../../../types";
...
export interface SunburstLabel extends BorderStyle, ShadowOptions {
  width: number;
  height: number;
  /**旋转 */
...
/**旭日图扇形块的样式 */
export interface ItemStyle extends ShadowOptions,BorderStyle {
  color?: string;
  decal?: Object;
}
