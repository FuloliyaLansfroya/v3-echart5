...
export default defineComponent({
  ...
  props: {
     ...
     * 传入数据类型为RatioOption[]
     */
    RatioOption:{type: Object, default: null},
  ...
  computed: {
    sortedData() {
      const cloneData = _.cloneDeep(this.$props.data);
      console.log(cloneData)
      return sortData(cloneData as RatioDataType, this.$props.sortType);
    },
  },
  methods: {
    getOptions(): any {
      ...
      const options: Record<string, any> = {
        tooltip: tooltip(this.$props.tooltipFormatter, undefined, defaultFormatter),
        series: series(this.sortedData, this.$props.RatioOption,this.$props.labelPosition),
      };
